...
function postcardTemplate({
  ...
  const safeDate = date || "";
  const safeActivity =
    activity || "A little adventure chosen for you by LOST.";
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
    ...
    <tr>
      <td style="padding:12px 24px 4px 24px;font-size:14px;line-height:1.6;color:#e5e7eb;background:#020617;">
        ...
        <p style="margin:0 0 10px 0;">${safeActivity}</p>
        <p style="margin:0;">
    ...
    <tr>
      <td style="padding:16px 24px 20px 24px;background:#020617;">
        ${
          mapImageUrl
            ? `
        <a href="${mapImageUrl}" style="text-decoration:none;color:#93c5fd;">
          <img src="${mapImageUrl}"
